...
export const NotificationMenu = () => {
  const dataTest = [
    {
      ...
      name: 'Fest X',
      date: '12/12/20 12:00',
      userAction: USER_ACTIONS.ACCEPTED,
    },
    {
      id: 2,
      name: 'Evento de fin de anio',
      date: '10/05/21 15:00',
      userAction: USER_ACTIONS.CANCELLED,
    },
    {
      id: 3,
      name: 'Evento Party 23',
      date: '12/12/20 12:00',
      userAction: USER_ACTIONS.NONE,
    },
    {
      id: 4,
      name: 'Festival de cine London',
      date: '15/01/21 12:00',
      userAction: USER_ACTIONS.NONE,
    },
  ];
  ...
  const [notifications, setNotifications] = useState(dataTest);
                  ...
                  {cancelEventMode && selectedNotification === item && (
                    <Fragment>
                      <p className="cancel-text">
                        Seguro que desea cancelar la invitacion?
                      </p>
                      <Button
                        label="Si"
                        color="white"
